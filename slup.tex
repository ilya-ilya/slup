...
\begin{lem}\label{lemsum}
  \sloppy
  Рассмотрим независимые геометрические величины $U_{0}, \ldots , U_{j+m}$ с параметром $p \in (0, 1)$, где $j = \left[ \frac{t}{\alpha} \right]$. Тогда при $t > \alpha$
  \begin{equation*}
...
\begin{cor}
  $\Expect Z(t) \leqslant A t$ и $\Expect Z(t)^2 \leqslant B t^2$. В частности, $Z(t) < \infty$ п.\,н. для любого $t \geqslant 0$.
\end{cor}
...
\begin{defn}
  Семейство случайных величин $\{ \xi_t, t \in T \}$ называется \emph{равномерно интегрируемым}, если
  \begin{equation*}
    \lim_{c \to \infty} \sup_{t \in T} \int_{ \left\{ |\xi_t| \geqslant c \right\}} |\xi_t| \dif\Prob = 0.
  \end{equation*}
\end{defn}
...
\begin{thm}
  Семейство случайных величин $\{ \xi_t, t\in T \}$<++>
\end{thm}<++>
...
\begin{thm}
  ...
  \begin{enumerate}
    ...
    \item $\displaystyle \frac{\Expect Z(t)}{t} \to \frac{1}{\mu}$ при $t \to \infty$, где $\frac{1}{0} := \infty$, $\frac{1}{\infty} := 0$.
  \end{enumerate}
\end{thm}
